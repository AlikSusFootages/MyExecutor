...
function Dozer:Start()
    if game:isLoaded() then
        ...
        Executorr.ScrollingFrame.TextBox:GetPropertyChangedSignal("Text"):Connect(function()
            Executorr.ScrollingFrame.CanvasSize = UDim2.new(1,Executorr.ScrollingFrame.TextBox.AbsoluteSize.X +32, 1, Executorr.ScrollingFrame.TextBox.AbsoluteSize.Y +24)
        end)
